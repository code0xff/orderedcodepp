...
const byte_t term[] = {0x00, 0x01};
const byte_t lit00[] = {0x00, 0xff};
const byte_t litff[] = {0xff, 0x00};
const byte_t inf[] = {0xff, 0xff};
const byte_t msb[] = {0x00, 0x80, 0xc0, 0xe0, 0xf0, 0xf8, 0xfc, 0xfe};
